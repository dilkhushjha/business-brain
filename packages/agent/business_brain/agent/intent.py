...
def classify_intent(question: str) -> str:
    ...
    if any(term in text for term in ("what should i do", "what should we do", "next step", "next steps", "what action", "what actions", "how should i respond", "how can i fix", "how do i fix", "should i ", "do i need to ", "is it worth ", "how can i improve", "how can i reduce", "how can i increase", "how can i prevent")):
