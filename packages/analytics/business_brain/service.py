...
from packages.analytics.business_brain.metrics.kpi_compat import KPI, average_invoice_value, growth
...
def monthly_sales_kpis(db: Session, business_id: UUID, as_of: date) -> list[KPI]:
    ...
    return [
        ...
        KPI("invoice_count", now.invoice_count, "count", "current_month", prior.invoice_count, growth(now.invoice_count, prior.invoice_count)),
