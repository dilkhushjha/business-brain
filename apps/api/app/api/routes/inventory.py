...
def slow_moving(business_id:UUID,days:int=30,threshold:float=40,limit:int=10,db:Session=Depends(get_db)): return slow_moving_products(db,business_id,days,threshold,limit)
