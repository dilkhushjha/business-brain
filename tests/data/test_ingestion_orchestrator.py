...
def test_prepare_csv(tmp_path: Path):
    ...
    path.write_text(
        "Party Name,Invoice No,Bill Date,Item Name,Qty,Rate,Total\n"
        "ABC Electricals,INV-1,27/08/2026,LED Bulb 9W,2,100,200\n"
        "XYZ Electricals,INV-2,28/08/2026,LED Bulb 9W,three,100,300\n",
        encoding="utf-8",
    )
